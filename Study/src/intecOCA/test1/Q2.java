...
import bookTests.workingWithInheritance.px.TestClass;
...
public class Q2 {
    ...
    public static void main(String[] args) {
        Integer a = 4; new Q2().probe(a); //5
        int b = 4; new Q2().probe(b); //6
    }
}
/*
...
это значит, что расширение примитивов (widening) предпочтительнее, чем boxing/unboxing.
...
- Расширение примитивов (Widening)
- Boxing/Unboxing
- Var-args (переменное количество аргументов)
